...
6. Place the `assembled torso bottom external` and the `torso bottom internal orin`, as shown in the first following picture. Make
...
5. Install the `stewart stand` onto the assembly with `M3x12 plastic screws`.
...
6. Install the first `stewart stand with an antenna` onto the assembly with `M3x12 plastic screws`.

![Antenna 1](images/assemblies/08D%20antenna%201.jpg)
![Stewart Stand](images/assemblies/08E%20stewart%20support%202.jpg)

7. Install the second `stewart stand with an antenna` onto the assembly with `M3x12 plastic screws`.
