...
![Soldered Adafruit MAX9744](images/assemblies/03/Adafruit-MAX9744-1.jpg)

2. Solder the `AD1` bridge on one of the `Adafruit MAX9744 kit`.

![Soldered Adafruit MAX9744](images/assemblies/03/Adafruit-MAX9744-2.jpg)
...
![PSU Control PCB - 1](images/assemblies/03/psu-control-1.jpg)
...
![PSU Control PCB - 2](images/assemblies/03/psu-control-2.jpg)

15. Solder TH2.
16. Solder R25 and R26.
17. Solder C25, C26, C27, C28, C29 and C30.

![PSU Control PCB - 3](images/assemblies/03/psu-control-3.jpg)
...
![PSU Control PCB - 4](images/assemblies/03/psu-control-4.jpg)

23. Solder U7.
24. Solder C17, C18, C19, C20 and C21.

![PSU Control PCB - 5](images/assemblies/03/psu-control-5.jpg)
...
![PSU Control PCB - 6](images/assemblies/03/psu-control-6.jpg)

34. Solder R43 and R44.
35. Solder C4 and C31.

![PSU Control PCB - 7](images/assemblies/03/psu-control-7.jpg)
...
![Teensy](images/assemblies/03/cut-teensy-lc.jpg)

45. Solder the male headers to the Teensy LC.

![Teensy](images/assemblies/03/teensy-lc.jpg)

46. Solder the female headers (U2) to the PCB.
47. Solder C6.
48. Clip the Teensy LC onto the PCB.

![PSU Control PCB - 8](images/assemblies/03/psu-control-8.jpg)
...
![PSU Control PCB - 1](images/assemblies/03/dynamixel-control-1.jpg)

6. Solder U5.
7. Solder C7, C8, C9, C10 and C11.

![PSU Control PCB - 2](images/assemblies/03/dynamixel-control-2.jpg)
...
![PSU Control PCB - 3](images/assemblies/03/dynamixel-control-3.jpg)
...
![PSU Control PCB - 4](images/assemblies/03/dynamixel-control-4.jpg)

18. Solder U2.
19. Solder R1 and R3.
20. Solder C4 and C5.

![PSU Control PCB - 5](images/assemblies/03/dynamixel-control-5.jpg)
...
![PSU Control PCB - 6](images/assemblies/03/dynamixel-control-6.jpg)
...
![Teensy](images/assemblies/03/cut-teensy-4.jpg)

30. Solder the male headers to the Teensy 4.0.

![Teensy](images/assemblies/03/teensy-4.jpg)
...
![Battery Charger - Desolder](images/assemblies/03/RRC-PMM240-horizontal.jpg)

2. Solder the `JST B2P-VH connectors`, as shown in the following picture.

![Battery Charger - Desolder](images/assemblies/03/RRC-PMM240-vertical.jpg)
