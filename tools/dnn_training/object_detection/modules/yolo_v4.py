...
class YoloV4(nn.Module):
    ...
    def load_weights(self, weights_file_path):
        ...
        offset = self._load_batch_norm_conv_weights(self._conv6, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv8, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv10, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv11, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv12, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv14, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv15, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv16, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv18, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv19, weights, offset)
        ...
        offset = self._load_batch_norm_conv_weights(self._conv24, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv25, weights, offset)
        ...
        offset = self._load_batch_norm_conv_weights(self._conv29, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv31, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv32, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv34, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv35, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv37, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv38, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv40, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv41, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv43, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv44, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv46, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv47, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv49, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv50, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv52, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv54, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv55, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv56, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv58, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv59, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv60, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv62, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv63, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv65, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv66, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv68, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv69, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv71, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv72, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv74, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv75, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv77, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv78, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv80, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv81, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv83, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv85, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv86, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv87, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv89, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv90, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv91, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv93, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv94, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv96, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv97, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv99, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv100, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv102, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv104, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv105, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv106, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv107, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv114, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv115, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv116, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv117, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv120, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv122, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv123, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv124, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv125, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv126, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv127, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv130, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv132, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv133, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv134, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv135, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv136, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv137, weights, offset)
        offset = self._load_conv_weights(self._conv138, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv141, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv143, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv144, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv145, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv146, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv147, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv148, weights, offset)
        offset = self._load_conv_weights(self._conv149, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv152, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv154, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv155, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv156, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv157, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv158, weights, offset)
        offset = self._load_batch_norm_conv_weights(self._conv159, weights, offset)
        offset = self._load_conv_weights(self._conv160, weights, offset)
