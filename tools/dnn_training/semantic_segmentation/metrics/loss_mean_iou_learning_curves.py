...
class LossMeanIoULearningCurves:
    def __init__(self):
        self._training_loss_values = []
        self._validation_loss_values = []
        self._training_mean_iou_values = []
        self._validation_mean_iou_values = []
    ...
    def add_training_mean_iou_value(self, value):
        self._training_mean_iou_values.append(value)
    ...
    def _save_figure(self, path):
        ...
        epochs = range(1, len(self._training_mean_iou_values) + 1)
        ax2.plot(epochs, self._training_mean_iou_values, '-o', color='tab:blue', label='Training')
        ax2.plot(epochs, self._validation_mean_iou_values, '-o', color='tab:orange', label='Validation')
        ax2.set_title(u'Mean IoU')
