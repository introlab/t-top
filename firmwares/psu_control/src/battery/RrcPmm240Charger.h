#ifndef PSU_CONTROL_BATTERY_RRC_PMM_240_CHARGER_H
#define PSU_CONTROL_BATTERY_RRC_PMM_240_CHARGER_H
...
public:
    ...
    DECLARE_NOT_COPYABLE(RrcPmm240Charger);
    DECLARE_NOT_MOVABLE(RrcPmm240Charger);
