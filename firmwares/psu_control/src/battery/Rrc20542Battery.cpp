...
{
    uint16_t value;
    if (!readWordTrials(0x08, value, trialCount))
    {
        return false;
    }
...
{
    uint16_t value;
    if (!readWordTrials(0x09, value, trialCount))
    {
        return false;
    }
...
{
    uint16_t value;
    if (!readWordTrials(0x0a, value, trialCount))
    {
        return false;
    }
...
{
    uint16_t value;
    if (!readWordTrials(0x0b, value, trialCount))
    {
        return false;
    }
...
{
    uint16_t value;
    if (!readWordTrials(0x0d, value, trialCount))
    {
        return false;
    }
...
{
    uint16_t value;
    if (!readWordTrials(0x0e, value, trialCount))
    {
        return false;
    }
...
{
    uint16_t value;
    if (!readWordTrials(0x0f, value, trialCount))
    {
        return false;
    }
...
{
    uint16_t value;
    if (!readWordTrials(0x10, value, trialCount))
    {
        return false;
    }
...
{
    uint16_t value;
    if (!readWordTrials(0x11, value, trialCount))
    {
        return false;
    }
...
{
    uint16_t value;
    if (!readWordTrials(0x12, value, trialCount))
    {
        return false;
    }
...
{
    uint16_t value;
    if (!readWordTrials(0x13, value, trialCount))
    {
        return false;
    }
...
bool Rrc20542Battery::readBatteryStatus(
...
{
    uint16_t value;
    if (!readWordTrials(0x16, value, trialCount))
    {
        return false;
    }
...
{
    uint16_t value;
    if (!readWordTrials(0x18, value, trialCount))
    {
        return false;
    }
...
{
    uint16_t value;
    if (!readWordTrials(0x19, value, trialCount))
    {
        return false;
    }
...
bool Rrc20542Battery::readManufacturerName(char* name, uint8_t maxNameSize, size_t trialCount)
{
    ...
    uint8_t size = 0;
    if (!readBlockTrials(0x20, maxNameSize - 1, name, size, trialCount))
    {
        return false;
    }
...
bool Rrc20542Battery::readDeviceName(char* name, uint8_t maxNameSize, size_t trialCount)
{
    ...
    uint8_t size = 0;
    if (!readBlockTrials(0x21, maxNameSize - 1, name, size, trialCount))
    {
        return false;
    }
...
bool Rrc20542Battery::readDeviceChemistry(char* name, uint8_t maxNameSize, size_t trialCount)
{
    ...
    uint8_t size = 0;
    if (!readBlockTrials(0x22, maxNameSize - 1, name, size, trialCount))
    {
        return false;
    }
...
{
    uint16_t value;
    if (!readWordTrials(0x1b, value, trialCount))
    {
        return false;
    }
