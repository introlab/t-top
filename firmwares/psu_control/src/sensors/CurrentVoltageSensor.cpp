...
bool CurrentVoltageSensor::begin() {
  ...
  return m_ina.begin(max_current, shunt_resistor, INA_ADC_MODE_128AVG, INA_ADC_MODE_128AVG, INA_MODE_CONTINUOUS_BOTH, INA220_ADDRESSES, INA220_COUNT) == INA220_COUNT;
#elif INA_TYPE == INA226_TYPE
  if (!m_ina.begin(INA_ADDRESS)) {
    return false;
  }
  if (m_ina.configure(INA226_AVERAGES_128, INA226_BUS_CONV_TIME_1100US, INA226_SHUNT_CONV_TIME_1100US, INA226_MODE_SHUNT_BUS_CONT)) {
    return false;
  }
