#ifndef DYNAMIXEL_CONTROL_MATH_TRUST_REGION_REFLECTIVE_SOLVER_H
#define DYNAMIXEL_CONTROL_MATH_TRUST_REGION_REFLECTIVE_SOLVER_H
...
public:
    ...
    TrustRegionReflectiveSolverResult<S> solve(
        F f,
...
private:
    ...
    template<int S>
    void computeGrad(
        Eigen::Matrix<float, S, 1>& grad,
        const Eigen::Matrix<float, S, 1>& f,
        const Eigen::Matrix<float, S, S>& J);

    template<int S>
    void clScalingVector(
        Eigen::Matrix<float, S, 1>& v,
    ...
    template<int S>
    void solveLsqTrustRegion(
        Eigen::Matrix<float, S, 1>& p,
        float& alpha,
    ...
    template<int S>
    void phiAndDerivative(
        float& phi,
        float& phiPrime,
        float alpha,
        const Eigen::Matrix<float, S, 1>& suf,
        const Eigen::Matrix<float, S, 1>& s,
        float delta);
...
template<class F, int S>
TrustRegionReflectiveSolverResult<S> TrustRegionReflectiveSolver::solve(
    F fun,
    const Eigen::Matrix<float, S, 1>& x0,
    const Eigen::Matrix<float, S, 1>& lowerBound,
    const Eigen::Matrix<float, S, 1>& upperBound)
...
template<int S>
void TrustRegionReflectiveSolver::makeStrictlyFeasible(
    Eigen::Matrix<float, S, 1>& x,
    const Eigen::Matrix<float, S, 1>& lowerBound,
    const Eigen::Matrix<float, S, 1>& upperBound)
{
...
template<int S>
void TrustRegionReflectiveSolver::computeGrad(
    Eigen::Matrix<float, S, 1>& grad,
    const Eigen::Matrix<float, S, 1>& f,
    const Eigen::Matrix<float, S, S>& J)
{
...
template<int S>
void TrustRegionReflectiveSolver::clScalingVector(
    Eigen::Matrix<float, S, 1>& v,
    Eigen::Matrix<float, S, 1>& dv,
    const Eigen::Matrix<float, S, 1>& x,
    const Eigen::Matrix<float, S, 1>& grad,
...
template<int S>
void TrustRegionReflectiveSolver::solveFAugmented(
    Eigen::Matrix<float, S, S>& Jh,
    Eigen::Matrix<float, S, 1>& s,
    Eigen::Matrix<float, S, S>& V,
    Eigen::Matrix<float, S, 1>& uf,
...
template<int S>
void TrustRegionReflectiveSolver::solveLsqTrustRegion(
    Eigen::Matrix<float, S, 1>& p,
    float& alpha,
    const Eigen::Matrix<float, S, 1>& s,
    const Eigen::Matrix<float, S, S>& V,
...
template<int S>
void TrustRegionReflectiveSolver::phiAndDerivative(
    float& phi,
    float& phiPrime,
    float alpha,
    const Eigen::Matrix<float, S, 1>& suf,
...
template<int S>
void TrustRegionReflectiveSolver::selectStep(
    Eigen::Matrix<float, S, 1>& step,
    Eigen::Matrix<float, S, 1>& stepH,
    float& predictedReduction,
    const Eigen::Matrix<float, S, 1>& x,
...
template<int S>
bool TrustRegionReflectiveSolver::inBounds(
    const Eigen::Matrix<float, S, 1>& x,
    const Eigen::Matrix<float, S, 1>& lowerBound,
    const Eigen::Matrix<float, S, 1>& upperBound)
{
...
template<int S>
float TrustRegionReflectiveSolver::evaluateQuadratic(
    const Eigen::Matrix<float, S, S>& J,
    const Eigen::Matrix<float, S, 1>& g,
    const Eigen::Matrix<float, S, 1>& s,
    const Eigen::Matrix<float, S, 1>& diag)
...
template<int S>
void TrustRegionReflectiveSolver::stepSizeToBound(
    float& minStep,
    Eigen::Matrix<int, S, 1>& hits,
    const Eigen::Matrix<float, S, 1>& x,
    const Eigen::Matrix<float, S, 1>& s,
...
template<int S>
void TrustRegionReflectiveSolver::intersectTrustRegion(
    float& t1,
    float& t2,
    const Eigen::Matrix<float, S, 1>& x,
    const Eigen::Matrix<float, S, 1>& s,
...
template<int S>
void TrustRegionReflectiveSolver::buildQuadratic1d(
    float& a,
    float& b,
    float& c,
    const Eigen::Matrix<float, S, S>& J,
...
inline void TrustRegionReflectiveSolver::minimizeQuadratic1d(
    float& x,
    float& y,
    float a,
    float b,
...
inline void TrustRegionReflectiveSolver::updateTrRadius(
    float& deltaNew,
    float& ratio,
    float delta,
    float actualReduction,
