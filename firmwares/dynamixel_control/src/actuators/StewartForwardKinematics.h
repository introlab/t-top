#ifndef DYNAMIXEL_CONTROL_ACTUATORS_STEWART_FORWARD_KINEMATICS_H
#define DYNAMIXEL_CONTROL_ACTUATORS_STEWART_FORWARD_KINEMATICS_H

#include "StewartKinematicsParameters.h"
#include "../math/TrustRegionReflectiveSolver.h"
