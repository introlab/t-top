...
ControlPanel::ControlPanel(ros::NodeHandle& nodeHandle, QWidget* parent) : QWidget(parent), m_nodeHandle(nodeHandle)
{
...
void ControlPanel::createUi()
{
    ...
    m_avatarTab = new AvatarTab;
    m_speechTab = new SpeechTab;
    m_gestureTab = new GestureTab;
    m_behaviorsTab = new BehaviorsTab;
    m_perceptionsTab = new PerceptionsTab(m_nodeHandle);
