...
class WeatherCommandExecutor : public SpecificCommandExecutor<WeatherCommand>
{
    ...
    rclcpp::Client<cloud_data::srv::CurrentLocalWeatherOpenMeteo>::SharedPtr m_currentWeatherClient;
    rclcpp::Client<cloud_data::srv::LocalWeatherForecastOpenMeteo>::SharedPtr m_weatherForecastClient;
