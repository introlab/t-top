...
{
    auto alarm = toAlarm(AddAlarmCommand("allo", AlarmType::PUNCTUAL, std::nullopt, Date(2022, 8, 1), Time(6, 30)));
...
{
    auto alarm = toAlarm(AddAlarmCommand("allo", AlarmType::DAILY, std::nullopt, std::nullopt, Time(7, 30)));
...
{
    auto alarm = toAlarm(AddAlarmCommand("allo", AlarmType::WEEKLY, 0, std::nullopt, Time(8, 30)));
