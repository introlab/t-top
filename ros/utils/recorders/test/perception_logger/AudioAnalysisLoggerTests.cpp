...
{
    AudioAnalysis analysis0(Timestamp(1), Direction{2.0, 3.0, 4.0}, "a");
    ...
    EXPECT_EQ(analysis1.timestamp.unixEpoch, 5.0);
    ...
    EXPECT_EQ(analysis1.voiceDescriptor, vector<float>({9.f}));
}
