...
class FaceDescriptorExtractor(DnnModel):
    def __init__(self, inference_type=None):
        torch_script_model_path = os.path.join(PACKAGE_PATH, 'models', 'face_descriptor_open_face_e256.ts.pth')
        tensor_rt_model_path = os.path.join(PACKAGE_PATH, 'models', 'face_descriptor_open_face_e256.trt.pth')
