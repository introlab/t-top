...
from cloud_data.srv import Location, CurrentLocalWeather, LocalWeatherForecast, CurrentLocalWeatherOpenMeteo, LocalWeatherForecastOpenMeteo
...
class OpenWeatherCloudDataNode(rclpy.node.Node):
    def __init__(self):
        ...
        self._location_service = self.create_service(Location, 'cloud_data/open_weather/location', self._handle_location)
...
class OpenMeteoCloudDataNode(rclpy.node.Node):
    def __init__(self):
        ...
        self._location_service = self.create_service(Location, 'cloud_data/open_meteo/location', self._handle_location)
        self._current_local_weather_service = self.create_service(CurrentLocalWeatherOpenMeteo,
                                                                  'cloud_data/open_meteo/current_local_weather',
                                                                  self._handle_current_local_weather)
        self._local_weather_forecast_service = self.create_service(LocalWeatherForecastOpenMeteo,
