...
def main():
    rospy.init_node('test_on_off_hbba_approximate_time_synchronizer')
    sub1 = message_filters.Subscriber('int_topic_1', Int32Stamped)
    sub2 = message_filters.Subscriber('int_topic_2', Int32Stamped)
    _ = hbba_lite.OnOffHbbaApproximateTimeSynchronizer([sub1, sub2], 10, 0.1, callback, 'int_topics/filter_state')
    rospy.spin()
